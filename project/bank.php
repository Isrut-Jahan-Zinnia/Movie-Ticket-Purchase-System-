...
<div id="mainContainer" class="row large-centered">
  ...
  <dl class="mercDetails">
    ...
    <dt>Transaction Amount</dt> 	<dd>TAKA <?php echo  $_SESSION['amount'];?></dd>
...
<label>&nbsp;</label><button  class="expanded button next" onClick="ValidateForm()" style="background-color: blue !important;">Make Payment</button>
</div>
</div>
